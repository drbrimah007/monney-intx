...
async function sendReminderEmail({ to, fromName, fromEmail, message, invoiceNumber, amount, totalAmt, paidAmt, viewUrl, siteUrl, appName, tagline, txType, isSelf, entryStatus, logoData, currency }) {
